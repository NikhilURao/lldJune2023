...
public class Sorter implements Callable<List<Integer>> {
    ...
    public List<Integer> call() throws Exception {
        ...
        Sorter leftSorter = new Sorter(leftArrayToSort, ex);
        Sorter rightSorter = new Sorter(rightArrayToSort, ex);

        Future<List<Integer>> leftSortedArrayFuture = ex.submit(leftSorter);
        Future<List<Integer>> rightSortedArrayFuture = ex.submit(rightSorter);
